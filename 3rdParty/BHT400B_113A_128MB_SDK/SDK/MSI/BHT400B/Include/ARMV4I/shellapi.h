...
HICON WINAPI ExtractIconExA(LPCSTR lpszFile, int nIconIndex, __out __opt HICON *phiconLarge, __out __opt HICON *phiconSmall, UINT nIcons);
#endif

#ifndef ExtractIconExW
HICON WINAPI ExtractIconExW(LPCWSTR lpszFile, int nIconIndex, __out __opt HICON *phiconLarge, __out __opt HICON *phiconSmall, UINT nIcons);
#endif
...
DWORD WINAPI SHGetFileInfo(LPCTSTR pszPath, DWORD dwFileAttributes,
						   __out_bcount(cbFileInfo) SHFILEINFOW *psfi, UINT cbFileInfo, UINT uFlags);
