...
// esp. if someone else is working with input.  I.E., if some other thread
...
#if WINVER < 0x0500 || defined(WINCE) // these structures and functions
		    // are in NT 5.00 and above winuser.h
...
#if defined(WINCE) && CE_MAJOR_VER < 0x0003
