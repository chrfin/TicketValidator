...
#define DOT11_AUTH_ALGORITHM_RSNA               0x00000006
#define DOT11_AUTH_ALGORITHM_RSNA_PSK           0x00000007
...
#define MAX_NUM_SUPPORTED_RATES_V1              255
...
DWORD
WINAPI
SetDot11NICPowerState(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11NICPowerState,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11NICPowerState(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11NICPowerState,
    LPVOID pvReserved
...
GetDot11RFUsage(
    HANDLE hAdapter,
    DWORD dwVersion,
    PULONG puDot11RFUsage,
    LPVOID pvReserved
    );

DWORD
WINAPI
SetDot11MacFilterControlMode(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_MAC_FILTER_CONTROL_MODE pDot11MacFilterControlMode,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11MacFilterControlMode(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_MAC_FILTER_CONTROL_MODE pDot11MacFilterControlMode,
    LPVOID pvReserved
...
DWORD
WINAPI
SetDot11MacFilterControl(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_MAC_FILTER_CONTROL_MODE pDot11MacFilterControlMode,
    PDOT11_MAC_FILTER_CONTROL pDot11MacFilterControl,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11MacFilterControls(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_MAC_FILTER_CONTROL_MODE pDot11MacFilterControlMode,
    PDOT11_MAC_FILTER_CONTROL * ppDot11MacFilterControls,
    PDWORD pdwNumOfEntries,
    LPVOID pvReserved
    );
...
DWORD
WINAPI
GetDot11ExtdAssocInfo(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_MAC_ADDRESS pDot11PeerMacAddress,
    PULONG puAssocInfoType,
    PDOT11_EXTD_ASSOC_INFO * ppDot11ExtdAssocInfo,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11DSSSOFDMImplemented(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11DSSSOFDMImplemented,
    LPVOID pvReserved
    );

DWORD
WINAPI
SetDot11DSSSOFDMMode(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_DSSS_OFDM_MODE pDot11DSSSOFDMMode,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11DSSSOFDMMode(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_DSSS_OFDM_MODE pDot11DSSSOFDMMode,
    LPVOID pvReserved
...
DWORD
WINAPI
GetDot11ShortSlotTimeImplemented(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11ShortSlotTimeOptionImplemented,
    LPVOID pvReserved
    );

DWORD
WINAPI
SetDot11ShortSlotTimeMode(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_SHORT_SLOT_TIME_MODE pDot11ShortSlotTimeMode,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11ShortSlotTimeMode(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_SHORT_SLOT_TIME_MODE pDot11ShortSlotTimeMode,
    LPVOID pvReserved
...
DWORD
WINAPI
GetDot11ERPPBCCOptionImplemented(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11ERPPBCCOptionImplemented,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11WMEImplemented(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11WMEImplemented,
    LPVOID pvReserved
    );
...
DWORD
WINAPI
SetDot11WMEACParameterRecordList(
    HANDLE hAdapter,
    DWORD dwVersion,
    BOOL bIsBeaconACRecord,
    PDOT11_WME_AC_PARAMETER_RECORD_LIST pDot11WMEACParameterRecordList,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11WMEACParameterRecordList(
    HANDLE hAdapter,
    DWORD dwVersion,
    BOOL bIsBeaconACRecord,
    PDOT11_WME_AC_PARAMETER_RECORD_LIST * ppDot11WMEACParameterRecordList,
    LPVOID pvReserved
    );

DWORD
WINAPI
SetDot11WMEAdmissionRequest(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_WME_ADMISSION_REQUEST pDot11WMEAdmissionRequest,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11WMEAdmissionRequest(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_WME_ADMISSION_REQUEST pDot11WMEAdmissionRequest,
    LPVOID pvReserved
...
DWORD
WINAPI
SetDot11AutoFrequencySelectionEnabled(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11AutoFrequencySelectionEnabled,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11AutoFrequencySelectionEnabled(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11AutoFrequencySelectionEnabled,
    LPVOID pvReserved
...
DWORD
WINAPI
SetDot11RepeaterDesiredBSSID(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_MAC_ADDRESS pDot11RepeaterDesiredBSSID,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11RepeaterDesiredBSSID(
    HANDLE hAdapter,
    DWORD dwVersion,
    PDOT11_MAC_ADDRESS pDot11RepeaterDesiredBSSID,
    LPVOID pvReserved
...
DWORD
WINAPI
SetDot11HiddenSSIDEnabled(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11HiddenSSIDEnabled,
    LPVOID pvReserved
    );

DWORD
WINAPI
GetDot11HiddenSSIDEnabled(
    HANDLE hAdapter,
    DWORD dwVersion,
    PBOOL pbDot11HiddenSSIDEnabled,
    LPVOID pvReserved
...
CE_Password2Key(
    IN  PUCHAR          pucSSID,
    IN  DWORD           dwSSIDLength,
    IN  LPCSTR          cszPassword,
    OUT PUCHAR          pucKey);


//
//  CE devices may not have native wifi.   
//  Application not relyingon existence of native wifi modules can use
//  LoadLibrary() to access these APIs.
//

#define WLCLIENT_NAME   TEXT("wlclient.dll")

//  
//  Some handy function pointer prototypes.
//
typedef DWORD (*OPENDOT11ADAPTERHANDLE)(LPWSTR, DWORD, PDOT11_ADAPTER, LPVOID, PHANDLE);
typedef DWORD (*GETDOT11CURRENTOPMODE)(HANDLE, DWORD, PDOT11_CURRENT_OPERATION_MODE, LPVOID);
typedef DWORD (*GETDOT11RSSI)(HANDLE, DWORD, PULONG, LPVOID);
typedef DWORD (*CLOSEDOT11ADAPTERHANDLE)(HANDLE);
