...
#define IDH_PASSIVE_FTP  50588  //.inetcpl, Advanced tab, Use Passive FTP for compatibility with some firewalls and DSL modems
// not needed: #define IDH_ENABLE_FOLDER_FTP  50589  //.inetcpl, Advanced tab, Enable folder view for FTP sites

#define IDH_PRIV_COOKIE_THIRD_PARTY 50590 //Security Settings for Cookies (Internet Options)
#define IDH_DEL_COOKIE_THIRD_PARTY  50591 //delete cookies button
#define IDH_COOKIE_THIRD_PARTY     50593 //Security Alert dialog box for 1st-party cookies
#define IDH_COOKIE_FIRST_PARTY     50594 //Security Alert dialog box for 3rd-party cookies

//last number added 50594, start new ids with 50595
